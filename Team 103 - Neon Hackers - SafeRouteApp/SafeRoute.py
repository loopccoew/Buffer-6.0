...
unsafe_reports = [
    ...
    {"lat": 18.6800, "lon": 73.7800, "intensity": 0.6, "description": "Highway stretch, reports of speeding vehicles"}, 
    {"lat": 18.6400, "lon": 73.8800, "intensity": 0.5, "description": "Riverbank area, dimly lit at night"}, 
    {"lat": 18.5400, "lon": 73.9200, "intensity": 0.8, "description": "Remote outskirts, reports of robberies"}, 
    {"lat": 18.5500, "lon": 73.7600, "intensity": 0.6, "description": "Under construction metro area, poor lighting and construction hazards"}, 
    {"lat": 18.5000, "lon": 73.8800, "intensity": 0.7, "description": "Isolated park, late-night gatherings"},  
    {"lat": 18.4700, "lon": 73.8700, "intensity": 0.6, "description": "Construction area, poor lighting and pathways"},  
    {"lat": 18.4500, "lon": 73.8500, "intensity": 0.5, "description": "Remote road, reports of speeding vehicles"},  
    {"lat": 18.4800, "lon": 73.9000, "intensity": 0.8, "description": "Dense forest area, limited visibility at night"},
    {"lat": 18.4300, "lon": 73.8600, "intensity": 0.7, "description": "Isolated area, reports of theft and harassment"}, 
    {"lat": 18.4600, "lon": 73.8300, "intensity": 0.6, "description": "Underpass, dimly lit and less crowded"}, 
    {"lat": 18.4900, "lon": 73.9200, "intensity": 0.5, "description": "Riverbank area, dimly lit and isolated"}, 
    {"lat": 18.4400, "lon": 73.8800, "intensity": 0.8, "description": "Hilly area, reports of robberies and less traffic"}, 
    {"lat": 18.5270, "lon": 73.8400, "intensity": 0.7, "description": "Isolated alleyways, poor lighting and reports of petty crime"}, 
]
...
safe_taxi_stands = [
    ...
    {"name": "Bus Depot Taxi Stand", "lat": 18.5950, "lon": 73.7200, "notes": "Taxi stand near major bus depot"}, 
    {"name": "Highway Rest Stop Taxi", "lat": 18.6700, "lon": 73.7700, "notes": "Taxi services at highway rest stop"}, 
    {"name": "Pilgrim Taxi Stand", "lat": 18.6300, "lon": 73.8700, "notes": "Designated taxi stand for temple visitors"}, 
    {"name": "Residential Hub Taxi", "lat": 18.5350, "lon": 73.9100, "notes": "Taxi stand in residential hub"}, 
    {"name": "Metro Station Taxi", "lat": 18.5450, "lon": 73.7500, "notes": "Taxi stand near Metro station"}, 
]
...
def display_map(routes, start_coords, end_coords, scores):
    ...
    fmap = folium.Map(location=pune_coords, zoom_start=13)  
