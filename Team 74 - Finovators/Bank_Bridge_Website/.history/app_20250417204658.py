...
@app.route('/transactionlevel1', methods=['GET', 'POST'])
def level1():
    ...
    return render_template("level1.html", txn=current_txn, ledger=ledger, score=score)
...
def result():
    ...
    session.clear()
    return render_template("result.html", score=score, ledger=ledger)
